...
class DataTransformation():
    def __init__(self):
        ...
        self.goodData_path='TrainingSet_Rawfiles_after_validation/GoodData/'

    def addQuotestoSringValuesInColumn(self):
        log_file = open('Training_logs/quotesToStringValues.txt','a+')
        try:
            ...
            for file in files:
                ...
                data.to_csv(self.goodData_path+file)
